      ...
      <div className="program-container">
        <div className="program-content">
          ...
          <h3>
            ...
            teachers, and students with maladaptive behaviors due to a lack of
            not being able to communicate... we, as a society, need help and
            fast.
          </h3>
          <br />
          <p>
            In all Special Education schools or organizations, there are
            typically only one on one instruction learning strategies and they
            are inadequate when it comes to improving language, focus and
            behavior. They only offer extrinsic reward strategies (or token
            systems) which have to always be provided in order to get a child or
            young adult to do what is asked of them or to improve their
            learning. The individual with special needs has no inner motivation
            to improve or grow in learning...thereby resulting in poor
